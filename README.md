...
<main style="display: flex; flex-direction: column; align-items: center; padding: 4rem; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <header style="text-align: center; margin-bottom: 2rem;">
    <h1>Hi 👋, I'm <strong>@StevoMc</strong></h1>
    <p style="font-size: 1.25em; color: #555;">Experienced Fullstack Developer skilled in creating user-friendly interfaces and efficient back-end systems.</p>
  </header>
  ...
  <section style="margin-bottom: 2rem;">
    <a href="https://github.com/ryo-ma/github-profile-trophy" target="_blank" rel="noreferrer">
      <img src="https://github-profile-trophy.vercel.app/?username=stevomc&theme=onedark&row=1" alt="GitHub Trophies" style="max-width: 100%; height: auto;" />
    </a>
  </section>

  <section style="width: 100%; max-width: 800px; text-align: center;">
    <h3 style="margin-bottom: 1rem;">Languages and Tools</h3>
